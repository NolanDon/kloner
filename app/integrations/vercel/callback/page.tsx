...
export default function VercelIntegrationCallbackPage() {
    ...
    // On success: immediately bounce back into the dashboard wizard
    useEffect(() => {
        if (!isSuccess) return;

        try {
            // Optional: flag for wizard to know this was just connected
    ...
    // Success case: tiny fallback if redirect fails
    if (isSuccess) {
        return (
    ...
    // Error case: keep your existing nice UI
