        ...
        >
            ...
            <div className="absolute inset-4 overflow-hidden">
                ...
                <div
                    ...
                    className={`absolute z-[101] ${IS_MOBILE ? "bottom-20 left-1/2 -translate-x-1/2" : "top-5 left-1/2 -translate-x-1/2"}`}
                    style={!IS_MOBILE ? { marginLeft: !sidebarHidden ? "260px" : "0px" } : undefined}
                >
                    <div className="flex items-center gap-2">
                        ...
                        {/* Mode switcher */}
                        <div className="shrink-0 inline-flex items-center gap-1 rounded-full border border-neutral-200 bg-white/90/95 px-2 py-1 shadow-md">
                            <button
                                type="button"
                        ...
                        <div className="shrink-0 inline-flex items-center gap-1 rounded-full border border-neutral-200 bg-white/90/95 px-2 py-1 shadow-md">
                            ...
                            <button
                                ...
                                disabled={exporting}
                                className={`inline-flex h-6 items-center gap-1 rounded-full px-2 text-[11px] font-semibold transition-colors ${
                                    exporting
                                        ? "cursor-not-allowed bg-[#f55f2a]/70 text-white"
                                        : "bg-white/90 text-neutral-600 hover:bg-neutral-100"
                                }`}
                                title="Deploy"
                                aria-label="Deploy"
                ...
                {/* UI scale – bottom left */}
                <div className={`absolute ${IS_MOBILE ? 'bottom-20 left-3' : 'bottom-5 left-5'} z-10 flex items-center gap-2 rounded-full ${IS_MOBILE ? '' : 'bg-white/90 shadow-md'} px-2 py-1 `}>
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between border-b border-neutral-200 px-4 py-3">
                                <div className="text-xs font-semibold uppercase tracking-[0.16em] text-neutral-500">
                                    ...
                                    {sidePanelMode === "ai-library" && "AI images"}
                                    {sidePanelMode === "revision-chat" && "AI edits"}
                                    {sidePanelMode === "code" && "Code"}
                                </div>
                                <button
                                    type="button"
                                    ...
                                    className={`inline-flex h-9 w-9 items-center justify-center rounded-full border border-neutral-200 bg-white/80 text-neutral-700 shadow-sm transition ${
                                        closing ? "cursor-not-allowed opacity-60" : "hover:bg-neutral-100"
                                    }`}
