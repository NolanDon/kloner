                ...
                >
                    ...
                    <section className={`relative bg-slate-50 rounded-lg border flex flex-col max-lg:order-1 ${
                        ...
                        <div className="hidden lg:flex items-center justify-between mb-3">
                            {/* V1 Badge (dev only) */}
                            {isDevCodeMode && (
                                <div className="inline-flex items-center gap-1 rounded-full bg-neutral-600 px-2 py-1 text-[10px] font-semibold text-white shadow-md">
                                    V1
                                </div>
                            )}

                            {/* UI scale – bottom right */}
                            <div className="flex items-center gap-2 rounded-full bg-white/90 shadow-md px-2 py-1">
